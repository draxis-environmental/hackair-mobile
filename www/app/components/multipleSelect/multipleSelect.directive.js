    ...
    return {
      ...
      controller: function ($scope, $element, $attrs) {
        $scope.multipleSelect = {
          ...
          templateUrl:        $attrs.templateUrl || 'app/components/multipleSelect/multipleSelect.html',
        ...
        $ionicGesture.on('tap', function (e) {
          $scope.multipleSelect.tempOptions = $scope.options.map(function(option){
            ...
            tempOption[$scope.multipleSelect.optiontextProperty] = option[$scope.multipleSelect.optiontextProperty];
